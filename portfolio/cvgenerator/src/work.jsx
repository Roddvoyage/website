export default function WorkExperience(){
    ...
    <h5 style={{marginLeft:'5%', marginBottom:'4px'}}>title/profession</h5>
    ...
    <div style={{display: 'flex', flexDirection:'column'}}>
    <h5 style={{marginLeft:'5%', marginBottom:'4px'}}>company</h5>
    ...
    <div style={{display: 'flex', flexDirection:'column'}}>
    <h5 style={{marginLeft:'5%', marginBottom:'4px'}}>end date</h5>
    <input style={{height: '50px', marginLeft:'5%', marginRight:'5%', backgroundColor:'transparent', border: "white 2px solid", fontSize:'14pt', color:'white'}}/>
    </div>
    </div>
