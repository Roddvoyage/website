...
const editBoxH2 = document.querySelector("#edit-box h2");
...
function changeTitle() {
  editBoxH2.style.color ="transparent";
  ...
  if(editBox.style.height > "250px"){
    changeTitleInput.style.width = "250px";
    changeTitleInput.style.marginBottom = "120px";
  } else {
    changeTitleInput.style.width = "200px";
    changeTitleInput.style.marginBottom = "80px";
  }
...
function changeColor() {
  editBoxH2.style.color="transparent";
  changeColorx.style.transform = "translateY(-150%)";
  changeColorx.style.transition = "transform 250ms ease-in-out";
...
function dropdownMenu() {
  if (dropdown.style.display === "none") {
    ...
    menuDropdown.style.height = "220px";
  } else {
